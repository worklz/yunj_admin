;!function (win, doc) {
     ...
     * 页面初始化
     */
    YunjAdmin.prototype.init = function () {
     ...
     * 页面结束
     */
    YunjAdmin.prototype.end = function () {
     ...
     * @param is_refresh
     */
    YunjAdmin.prototype.add_tab = function (title, url, is_refresh) {
        //md5每个url
        let id = md5(url);
     ...
     * @param id
     */
    YunjAdmin.prototype.del_tab = function (id) {
        if (id) {
            console.log(88);
        } else {
     ...
     * @param id
     */
    YunjAdmin.prototype.add_lay_tab = function (title, url, id) {
     ...
     * @param full [全屏]
     */
    YunjAdmin.prototype.open = function (title, url, w, h, full) {
        title = title || false;
        url = url || "404.html";
        w = w || ($(window).width() * 0.9);
        h = h || ($(window).height() - 50);
     ...
     * 关闭弹出层
     */
    YunjAdmin.prototype.close = function () {
     ...
     * 关闭弹出层父窗口关闭
     */
    YunjAdmin.prototype.father_reload = function () {
     ...
     * @returns {*}
     */
    YunjAdmin.prototype.get_data = function () {
     ...
     * @returns {boolean}
     */
    YunjAdmin.prototype.set_data = function (title, url, id) {
     ...
     * @returns {*}
     */
    YunjAdmin.prototype.get_cate_data = function () {
        if (typeof is_remember !== "undefined") return false;
     ...
     * @returns {boolean}
     */
    YunjAdmin.prototype.set_cate_data = function (data) {
        if (typeof is_remember !== "undefined") return false;
     ...
     * @returns {boolean}
     */
    YunjAdmin.prototype.del_data = function (id) {
        if (typeof is_remember !== "undefined") return false;
     ...
     * @returns {boolean}
     */
    YunjAdmin.prototype.del_other_data = function (id) {
        if (typeof is_remember !== "undefined") return false;
...
layui.use(['layer', 'element', 'jquery'], function () {
    ...
    $('.left-nav #nav').on('click', 'li', function (event) {
        ...
        if ($(this).parent().attr('id') === 'nav') {
            yunj_admin.set_cate_data({key: 'f1', value: $('.left-nav #nav li').index($(this))});
            yunj_admin.set_cate_data({key: 'f2', value: null});
            yunj_admin.set_cate_data({key: 'f3', value: null});
        }

        if ($(this).parent().parent().parent().attr('id') === 'nav') {
            yunj_admin.set_cate_data({key: 'f2', value: $('.left-nav #nav li').index($(this))});
            yunj_admin.set_cate_data({key: 'f3', value: null});
        }

        if ($(this).parent().parent().parent().parent().parent().attr('id') === 'nav') {
            yunj_admin.set_cate_data({key: 'f3', value: $('.left-nav #nav li').index($(this))})
        }
